...
signals.post_delete.connect(PeriodStatement.transaction_post_delete, sender=IncomeTransaction)
signals.post_save.connect(PeriodStatement.transaction_post_save, sender=IncomeTransaction)
